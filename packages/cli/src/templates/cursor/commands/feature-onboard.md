...
### /feature-before-frontend-dev and /feature-before-backend-dev - Inject Specialized Knowledge

**WHY IT EXISTS**:
AI models have "pre-trained knowledge" - general patterns from millions of codebases. But YOUR project has specific conventions that differ from generic patterns.

**WHAT IT ACTUALLY DOES**:
1. Reads `.feature/spec/frontend/` or `.feature/spec/backend/`
...
### /feature-check-frontend and /feature-check-backend - Combat Context Drift
...
**[3/8] /feature-before-frontend-dev** - Inject project-specific frontend knowledge
**[4/8] Investigate and fix the bug** - Actual development work
**[5/8] /feature-check-frontend** - Re-verify code against guidelines
...
**[2/6] /feature-before-backend-dev** - Re-inject guidelines before fixes
**[3/6] Fix each CR issue** - Address feedback with guidelines in context
**[4/6] /feature-check-backend** - Verify fixes didn't introduce new issues
...
**[2/6] /feature-before-backend-dev** - Guidelines might document known gotchas
**[3/6] Investigation** - Actual debugging work
**[4/6] /feature-check-backend** - Verify debug changes don't break other things
