...
Use this command after `/feature:write-plan` to generate test cases before implementation:
...
cat _shared/testcase_spec.md

# Read test case template
cat _shared/testcase_template.md
...
|--------------|----------|----------------|
| Screen Control (PK) | ADU/CDU/DMC/A9/DC1801/Distributed KVM/Keyboard | `_shared/testcase_checklist_PK.md` |
| Conference (HY) | Conference tablet/OPS/Camera | `_shared/testcase_checklist_HY.md` |
| Info Publishing (XF) | Info publishing platform/Terminal software | `_shared/testcase_checklist_XF.md` |
...
**Simple Task Flow**:
```text
/feature:init-plan -> /feature:write-testcase -> implement -> /feature:check -> /feature:finish-work
```
...
Next command: /feature:check-testcase
