...
Check if your change needs new or updated tests (see `.feature/spec/unit-test/conventions.md`):
...
If running this checklist manually, ensure spec sync is complete before committing — run `/feature:update-spec` if needed.
