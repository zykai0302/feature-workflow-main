...
Create a new slash command in both `.qoder/commands/feature/` and `.claude/commands/feature/` directories based on user requirements.
...
- `.qoder/commands/feature/<command-name>.md`
