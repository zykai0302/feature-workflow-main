...
Before following this command, read `_shared/workflow-context.md`. Reuse current task findings, validation results, and spec context instead of rediscovering the same material.
