...
Before following this command, read `_shared/workflow-context.md`. Reuse already-loaded PRD, plan, findings, and progress unless they changed.
...
If the platform has strong subagent support and the tasks are mostly independent, prefer `/feature:subagent-work`.
