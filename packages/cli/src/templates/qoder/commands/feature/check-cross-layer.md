...
Before following this command, read `_shared/workflow-context.md`. Reuse current diff, findings, and spec context instead of re-running the same discovery work.

> **Note**: This is a **post-implementation** safety net. Ideally, read the [Pre-Implementation Checklist](.feature/spec/guides/pre-implementation-checklist.md) **before** writing code.
...
| ------------------------------------------------------------------------------------ | ----------------------- | ------------------------ |
| [Pre-Implementation Checklist](.feature/spec/guides/pre-implementation-checklist.md) | Questions before coding | **Before** writing code  |
| [Code Reuse Thinking Guide](.feature/spec/guides/code-reuse-thinking-guide.md)       | Pattern recognition     | During implementation    |
| **`/feature:check-cross-layer`** (this)                                              | Verification check      | **After** implementation |
...
**Detailed Guide**: `.feature/spec/guides/cross-layer-thinking-guide.md`
...
**Detailed Guide**: `.feature/spec/guides/code-reuse-thinking-guide.md`
...
If issues are resolved or no issues are found:
