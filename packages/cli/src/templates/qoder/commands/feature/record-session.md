...
Before following this command, read `_shared/workflow-context.md`. Reuse the current task summary and git context if they are already loaded and still current.
