...
Create a new slash command in both `.cursor/commands/` (with `feature-` prefix) and `.opencode/commands/feature/` directories based on user requirements.

## Usage

```
/feature:create-command <command-name> <description>
```
...
- `.opencode/commands/feature/<command-name>.md`
