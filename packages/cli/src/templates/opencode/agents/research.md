...
1. Read `.feature/.current-task` → get task directory (if exists)
...
- `.feature/spec/backend/` - Backend standards
- `.feature/spec/frontend/` - Frontend standards
- `.feature/spec/guides/` - Thinking guides
