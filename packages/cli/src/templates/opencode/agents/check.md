...
You are the Check Agent in the feature workflow.
...
1. Read `.feature/.current-task` → get task directory (e.g., `.feature/tasks/xxx`)
...
5. Read `.opencode/commands/feature/finish-work.md` for checklist
...
Read relevant specs in `.feature/spec/` to check code:
