...
`schema.yaml` in this directory is the canonical contract for `.feature/solutions/` frontmatter written by `ce:compound`.
...
- `build_error` -> `.feature/solutions/build-errors/`
- `test_failure` -> `.feature/solutions/test-failures/`
- `runtime_error` -> `.feature/solutions/runtime-errors/`
- `performance_issue` -> `.feature/solutions/performance-issues/`
- `database_issue` -> `.feature/solutions/database-issues/`
- `security_issue` -> `.feature/solutions/security-issues/`
- `ui_bug` -> `.feature/solutions/ui-bugs/`
- `integration_issue` -> `.feature/solutions/integration-issues/`
- `logic_error` -> `.feature/solutions/logic-errors/`
- `developer_experience` -> `.feature/solutions/developer-experience/`
- `workflow_issue` -> `.feature/solutions/workflow-issues/`
- `best_practice` -> `.feature/solutions/best-practices/`
- `documentation_gap` -> `.feature/solutions/documentation-gaps/`
