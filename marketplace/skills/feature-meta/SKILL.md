...
│  - .feature/spec/         - Platform commands/skills        │
...
ls -la .claude/skills/feature-local/
```
...
Then create `.claude/skills/feature-local/SKILL.md`:
...
┌─────────────────────────────────────────────────────────────────────┐
│                        USER INTERACTION                              │
│  /feature:start  /feature:brainstorm  /feature:parallel  /feature:finish-work │
└─────────────────────────────────┬───────────────────────────────────┘
                                  │
┌─────────────────────────────────▼───────────────────────────────────┐
│                         SKILLS LAYER                                 │
│  .claude/commands/feature/*.md   (slash commands)                   │
...
1. Create `.claude/commands/feature/my-command.md`
